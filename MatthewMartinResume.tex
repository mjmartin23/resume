...
\textit{Majors}: Computer Science and Government, \textit{Minor}: Mathematics\hfill\textbf{Overall GPA: 3.82/4.00}

\textit{Honors}: Dean's List: Fall 2014, Spring 2015, Fall 2015\hfill\textbf{CS Major GPA: 3.95/4.00}

\textit{Relevant Coursework}: Robotics, Object-Oriented Systems, Introduction to Vision and Robotics,\\Data Structures and Algorithms,Software Design and Modelling, Data Analysis and Visualization,\\Parallel and Distributed Processing, Computer Organization, Linear Algebra
...
\project{Enhanced Issue Lifetime Prediction Using Contextual Features}{Lead Researcher}{2016}{
	...
	\vspace{-.5em}
	\item I co-authored a paper documenting this which is currently under review at Mining Software Repositories '17
	}
	
\projecttype{Computer Vision and Robotics}
