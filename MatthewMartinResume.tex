...
\textit{Honors}: Dean's List: Fall 2014, Spring 2015, Fall 2015, Spring 2017\hfill\textbf{CS Major GPA: 3.95/4.00}
...
\job{Software Development Engineering Intern}{Amazon}{May - August 2017}{
	\item Created an internal web console and a file parser for Amazon's ``vision tunnels" that are used for sorting packages
	\vspace{-.5em}\item Became familiar with the scrum development process, learned about new technologies, and contributed to the success of my team
}
...
\job{Teaching Assistant}{Colby College Computer Science Department}{February 2015 - present}{
	\item Assist students with their computer science projects during and outside of class
}
