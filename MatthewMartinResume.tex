...
\usepackage{nopageno}
\usepackage[tmargin=0.3in,left=0.5in,right=0.5in,bmargin=0.3in]{geometry}
...
\project{Enhanced Issue Lifetime Prediction Using Contextual Features}{Lead Researcher}{2016}{
	\item At the conclusion of my summer research experience at NC State University, I presented a poster documenting a simpler and more accurate method of predicting issue lifetime in software projects than the current state of the art
	}
...
\project{Colby College Computer Science Department Website}{Co-Developer}{2016}{
	...
	\vspace{-.75em}
	\item Rebuilt the site from the ground up, and it is now the new location for every computer science student at Colby to access on a daily basis
	}
\project{Personal Site}{Sole Developer}{2016}{
	\item The domain \href{http://matthewmartin.me}{matthewmartin.me} is consistently updated with recent work, and has more detailed descriptions of my projects
}
